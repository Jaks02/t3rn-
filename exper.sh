...
# Ask if they want to enable EXECUTOR_PROCESS_BIDS
read -p "Do you want to enable EXECUTOR_PROCESS_PROCESS_BIDS? (y/n): " ENABLE_PROCESS_BIDS
if [[ "$ENABLE_PROCESS_BIDS" =~ ^[Yy]$ ]]; then
    EXECUTOR_PROCESS_BIDS_ENABLED=true
else
   EXECUTOR_PROCESS_BIDS_ENABLED=false
fi

# Ask if they want to enable EXECUTOR_PROCESS_ORDERS
read -p "Do you want to enable EXECUTOR_PROCESS_ORDERS_ENABLED? (y/n): " ENABLE_PROCESS_ORDERS
if [[ "$ENABLE_PROCESS_ORDERS" =~ ^[Yy]$ ]]; then
    EXECUTOR_PROCESS_ORDERS_ENABLED=true
else
    EXECUTOR_PROCESS_ORDERS_ENABLED=false
fi

# Ask if they want to enable EXECUTOR_PROCESS_CLAIMS
read -p "Do you want to enable EXECUTOR_PROCESS_PROCESS_CLAIMS_ENABLED? (y/n): " ENABLE_PROCESS_CLAIMS
if [[ "$ENABLE_PROCESS_CLAIMS" =~ ^[Yy]$ ]]; then
    EXECUTOR_PROCESS_CLAIMS_ENABLED=true
else
    EXECUTOR_PROCESS_CLAIMS_ENABLED=false
fi
...
export EXECUTOR_PROCESS_BIDS_ENABLED=$ENABLE_PROCESS_BIDS_ENABLED
export EXECUTOR_PROCESS_ORDERS_ENABLED=$EXECUTOR_PROCESS_BIDS_ENABLED
